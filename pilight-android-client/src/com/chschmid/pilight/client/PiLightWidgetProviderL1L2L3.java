...
public class PiLightWidgetProviderL1L2L3 extends AppWidgetProvider {
    ...
    public PiLightWidgetProviderL1L2L3() {
        // Start the worker thread
        sWorkerThread = new HandlerThread("PiLightWidgetL1L2L3-worker");
        sWorkerThread.start();
    ...
    private RemoteViews buildLayout(Context context, int appWidgetId, boolean largeLayout) {
        ...
        RemoteViews rv;
        rv = new RemoteViews(context.getPackageName(), R.layout.widget_layout_l1l2l3);
        
        final Intent onClickLight1Intent = new Intent(context, PiLightWidgetProviderL1L2L3.class);
        onClickLight1Intent.setAction(PiLightWidgetProviderL1L2L3.CLICK_LIGHT1);
        ...
        rv.setOnClickPendingIntent(R.id.imageView1, onClickLight1PendingIntent);
        
        final Intent onClickLight2Intent = new Intent(context, PiLightWidgetProviderL1L2L3.class);
        onClickLight2Intent.setAction(PiLightWidgetProviderL1L2L3.CLICK_LIGHT2);
        final PendingIntent onClickLight2PendingIntent = PendingIntent.getBroadcast(context, 0, onClickLight2Intent, PendingIntent.FLAG_UPDATE_CURRENT);
        rv.setOnClickPendingIntent(R.id.imageView2, onClickLight2PendingIntent);
        
        final Intent onClickLight3Intent = new Intent(context, PiLightWidgetProviderL1L2L3.class);
        onClickLight3Intent.setAction(PiLightWidgetProviderL1L2L3.CLICK_LIGHT3);
