...
public class PiLightWidgetProviderL1L2 extends AppWidgetProvider {
    ...
    public PiLightWidgetProviderL1L2() {
        // Start the worker thread
        sWorkerThread = new HandlerThread("PiLightWidgetL1L2-worker");
        sWorkerThread.start();
    ...
    private RemoteViews buildLayout(Context context, int appWidgetId, boolean largeLayout) {
        ...
        RemoteViews rv;
        rv = new RemoteViews(context.getPackageName(), R.layout.widget_layout_l1l2);
        
        final Intent onClickLight1Intent = new Intent(context, PiLightWidgetProviderL1L2.class);
        onClickLight1Intent.setAction(PiLightWidgetProviderL1L2.CLICK_LIGHT1);
        ...
        final Intent onClickLight2Intent = new Intent(context, PiLightWidgetProviderL1L2.class);
        onClickLight2Intent.setAction(PiLightWidgetProviderL1L2.CLICK_LIGHT2);
