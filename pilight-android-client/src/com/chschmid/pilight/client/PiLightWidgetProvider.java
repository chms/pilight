...
public class PiLightWidgetProvider extends AppWidgetProvider {
    ...
    public PiLightWidgetProvider() {
        // Start the worker thread
        sWorkerThread = new HandlerThread("PiLightWidget-worker");
        sWorkerThread.start();
    ...
    private RemoteViews buildLayout(Context context, int appWidgetId, boolean largeLayout) {
        ...
        final Intent onClickLight1Intent = new Intent(context, PiLightWidgetProvider.class);
        onClickLight1Intent.setAction(PiLightWidgetProvider.CLICK_LIGHT1);
        ...
        final Intent onClickLight2Intent = new Intent(context, PiLightWidgetProvider.class);
        onClickLight2Intent.setAction(PiLightWidgetProvider.CLICK_LIGHT2);
        ...
        final Intent onClickLight3Intent = new Intent(context, PiLightWidgetProvider.class);
        onClickLight3Intent.setAction(PiLightWidgetProvider.CLICK_LIGHT3);
