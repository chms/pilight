...
/**
 * Initializes the PiLight Server
...
public class LightServerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private static LightServerHandler serverHandler;
    
    public LightServerInitializer(PiLightInterface light) {
    	super();
    	serverHandler = new LightServerHandler(light);
    }
